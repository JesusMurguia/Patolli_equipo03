 ...
 * @author jesus
 */
public class FrmEsperandoJugadores extends javax.swing.JFrame {
...
this.numeroCasillas = numeroCasillas;        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEsperandoJugadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
